...
export type WorkspaceBrowserInjected = {
  ...
  /** Download the Host-provided session-log export archive. */
  exportSession: (sessionId: SessionId) => void
  /** Permanently delete one Session log after Host confirmation. */
  deleteSession: (sessionId: SessionId) => Promise<void>
  /** Move a quiescent Session into another Workspace as an inherited child. */
  migrateSession: (sessionId: SessionId, workspaceId: WorkspaceId) => Promise<SessionId>
  /**
