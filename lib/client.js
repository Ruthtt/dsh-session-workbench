window.__ModuleLoader__.load({ id: "dsh-session-workbench", factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/drag-contract.ts
		/** Versioned native DataTransfer type for a sidebar Session drag. */
		const SESSION_DRAG_MIME = "application/x-deepseek-session+json";
		/** Window event used by the pointer-driven sidebar drag path. */
		const SESSION_POINTER_DRAG_EVENT = "dsh:session-pointer-drag";
		/** Serialize one Session drag payload without carrying mutable metadata. */
		function serializeSessionDrag(sessionId) {
		...
		//#endregion
		//#region \0dsh-css:module:src/client/rows/Rows.module.css.mjs
		const css$2 = ".sS7PTG_projectRow,.sS7PTG_sessionRow{cursor:pointer;-webkit-user-select:none;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.sS7PTG_projectRow:hover,.sS7PTG_sessionRow:hover,.sS7PTG_sessionRow.sS7PTG_selected{background:var(--dsw-alias-interactive-bg-hover)}.sS7PTG_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.sS7PTG_searchResultRow:hover,.sS7PTG_searchResultRow.sS7PTG_selected{background:var(--dsw-alias-interactive-bg-hover)}.sS7PTG_searchResultHeading{align-items:center;min-width:0;display:flex}.sS7PTG_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.sS7PTG_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.sS7PTG_searchResultWorkspace,.sS7PTG_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.sS7PTG_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.sS7PTG_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.sS7PTG_projectRow{box-sizing:border-box;align-items:center;height:34px}.sS7PTG_projectRow .sS7PTG_rowActions{height:20px}.sS7PTG_sessionRow{height:32px;animation:sS7PTG_row-in .15s var(--ds-ease-in-out);gap:0}.sS7PTG_sessionRow[data-pointer-draggable]{cursor:grab;touch-action:pan-y}.sS7PTG_sessionRow.sS7PTG_pointerDragging{cursor:grabbing;background:var(--dsw-alias-interactive-bg-hover)}.sS7PTG_sessionDragPreview{z-index:1000;box-sizing:border-box;border:1px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1);max-width:min(260px,100vw - 24px);height:32px;color:var(--dsw-alias-label-primary);pointer-events:none;text-overflow:ellipsis;white-space:nowrap;border-radius:6px;padding:6px 10px;font-size:13px;line-height:18px;position:fixed;overflow:hidden;box-shadow:0 8px 24px #00000047}.sS7PTG_sessionRow .sS7PTG_title{margin:0 6px 0 4px}.sS7PTG_flatSessionRowWithoutStatus .sS7PTG_title{margin-left:0}@keyframes sS7PTG_row-in{0%{opacity:0}}.sS7PTG_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.sS7PTG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.sS7PTG_folderActive{color:var(--dsw-alias-state-business-primary)}.sS7PTG_projectRow .sS7PTG_chevron{display:none}.sS7PTG_projectRow:hover .sS7PTG_chevron{display:inline-flex}.sS7PTG_projectRow:hover .sS7PTG_folder{display:none}.sS7PTG_arrow{transition:transform .15s var(--ds-ease-in-out)}.sS7PTG_arrowOpen{transform:rotate(90deg)}.sS7PTG_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.sS7PTG_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.sS7PTG_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.sS7PTG_sessionRow .sS7PTG_title{flex:1}.sS7PTG_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.sS7PTG_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.sS7PTG_dot{flex:none}.sS7PTG_rowActions{flex:none;align-items:center;gap:12px;display:none}.sS7PTG_projectRow:hover .sS7PTG_rowActions,.sS7PTG_sessionRow:hover .sS7PTG_rowActions,.sS7PTG_projectRow.sS7PTG_menuOpen .sS7PTG_rowActions,.sS7PTG_sessionRow.sS7PTG_menuOpen .sS7PTG_rowActions{display:inline-flex}.sS7PTG_sessionRow:hover .sS7PTG_time,.sS7PTG_sessionRow.sS7PTG_menuOpen .sS7PTG_time{display:none}.sS7PTG_projectRow.sS7PTG_menuOpen,.sS7PTG_sessionRow.sS7PTG_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.sS7PTG_sessionRow.sS7PTG_dropBefore,.sS7PTG_sessionRow.sS7PTG_dropAfter{position:relative}.sS7PTG_sessionRow.sS7PTG_dropBefore:before,.sS7PTG_sessionRow.sS7PTG_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.sS7PTG_sessionRow.sS7PTG_dropBefore:before{top:-7px}.sS7PTG_sessionRow.sS7PTG_dropAfter:after{bottom:-7px}.sS7PTG_hoverContent{flex-direction:column;gap:8px;display:flex}.sS7PTG_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.sS7PTG_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.sS7PTG_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.sS7PTG_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.sS7PTG_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.sS7PTG_iconButton:hover{color:var(--dsw-alias-label-primary)}.sS7PTG_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.sS7PTG_sessionRow,.sS7PTG_arrow{transition:none;animation:none}}";
		const tagId$2 = "dsh-session-workbench/Rows.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$2) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-session-workbench";
			tag.dataset.pluginCss = tagId$2;
			tag.textContent = css$2;
			document.head.appendChild(tag);
		}
		var Rows_module_css_default = {
			"sessionDragPreview": "sS7PTG_sessionDragPreview",
			"time": "sS7PTG_time",
			"hoverContent": "sS7PTG_hoverContent",
			"sessionRow": "sS7PTG_sessionRow",
			"arrow": "sS7PTG_arrow",
			"slot": "sS7PTG_slot",
			"searchResultSnippet": "sS7PTG_searchResultSnippet",
			"row-in": "sS7PTG_row-in",
			"selected": "sS7PTG_selected",
			"meta": "sS7PTG_meta",
			"dropBefore": "sS7PTG_dropBefore",
			"pointerDragging": "sS7PTG_pointerDragging",
			"folder": "sS7PTG_folder",
			"searchResultMeta": "sS7PTG_searchResultMeta",
			"menuOpen": "sS7PTG_menuOpen",
			"chevron": "sS7PTG_chevron",
			"renameInput": "sS7PTG_renameInput",
			"searchResultWorkspace": "sS7PTG_searchResultWorkspace",
			"flatSessionRowWithoutStatus": "sS7PTG_flatSessionRowWithoutStatus",
			"searchResultTitle": "sS7PTG_searchResultTitle",
			"title": "sS7PTG_title",
			"searchResultHeading": "sS7PTG_searchResultHeading",
			"arrowOpen": "sS7PTG_arrowOpen",
			"searchResultRow": "sS7PTG_searchResultRow",
			"visuallyHidden": "sS7PTG_visuallyHidden",
			"hoverStatus": "sS7PTG_hoverStatus",
			"dropAfter": "sS7PTG_dropAfter",
			"folderActive": "sS7PTG_folderActive",
			"hoverTime": "sS7PTG_hoverTime",
			"projectRow": "sS7PTG_projectRow",
			"hoverPath": "sS7PTG_hoverPath",
			"rowActions": "sS7PTG_rowActions",
			"iconButton": "sS7PTG_iconButton",
			"projectText": "sS7PTG_projectText",
			"dot": "sS7PTG_dot",
			"hoverTitle": "sS7PTG_hoverTitle"
		};
		//#endregion
		...
		* except workspace Rename/Delete and session Rename/Fork/Export/Archive/Delete; the session
		...
		function SessionHoverContent({ node, now, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: Rows_module_css_default.hoverPath,
						children: t("hover.sessionId", { id: node.id })
					}),
		...
		* @param props.onExport - download the session-log export archive.
		...
		*/
		function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onExport, onDelete, drag, flat = false, t }) {
			const row = node;
			...
			const [menuOpen, setMenuOpen] = (0, react.useState)(false);
			const [pointerPosition, setPointerPosition] = (0, react.useState)(null);
			const pointerCleanupRef = (0, react.useRef)(null);
			const suppressClickRef = (0, react.useRef)(false);
			(0, react.useEffect)(() => () => {
				pointerCleanupRef.current?.();
			}, []);
			const emitPointerDrag = (detail) => {
				window.dispatchEvent(new CustomEvent(SESSION_POINTER_DRAG_EVENT, { detail }));
			};
			const onSessionPointerDown = (event) => {
				if (drag === void 0 || drag.pointer === void 0 || event.button !== 0 || !event.isPrimary) return;
				...
				const cleanup = () => {
					...
					if (rowElement.hasPointerCapture(pointerId)) rowElement.releasePointerCapture(pointerId);
				...
				const finish = (phase) => {
					...
					if (phase === "drop") pointer.drop(lastX, lastY);
					else pointer.cancel();
				...
				const onMove = (moveEvent) => {
					...
					if (!started && Math.hypot(lastX - startX, lastY - startY) < 6) return;
					if (!started) {
						started = true;
				...
				pointerCleanupRef.current = () => {
					if (suppressTimer !== void 0) clearTimeout(suppressTimer);
					cleanup();
				};
			};
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.HoverCard, {
				anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: clsx(Rows_module_css_default.sessionRow, selected && Rows_module_css_default.selected, menuOpen && Rows_module_css_default.menuOpen, pointerPosition !== null && Rows_module_css_default.pointerDragging, flat && !showStatus && Rows_module_css_default.flatSessionRowWithoutStatus, drag?.marker === "before" && Rows_module_css_default.dropBefore, drag?.marker === "after" && Rows_module_css_default.dropAfter),
					role: "treeitem",
					"aria-selected": selected,
					"data-session-drop-id": drag === void 0 ? void 0 : node.id,
					"data-session-drop-account": drag?.accountKey,
					"data-pointer-draggable": drag?.pointer === void 0 ? void 0 : "",
					onClick: (event) => {
					...
					draggable: drag !== void 0 && drag.pointer === void 0,
					onDragStart: drag === void 0 ? void 0 : (e) => {
						e.dataTransfer.effectAllowed = "copyMove";
						e.dataTransfer.setData(SESSION_DRAG_MIME, serializeSessionDrag(node.id));
					...
					children: [
						...
						pointerPosition !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: Rows_module_css_default.sessionDragPreview,
							style: {
								left: pointerPosition.x + 14,
		...
		//#endregion
		//#region \0dsh-css:module:src/client/WorkspacePicker.module.css.mjs
		const css$1 = ".F4jEqG_modalAction{min-width:72px}.F4jEqG_modalError,.F4jEqG_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.F4jEqG_modalError{color:var(--dsw-alias-state-error-primary)}.F4jEqG_menuStatus{color:var(--dsw-alias-label-secondary)}";
		const tagId$1 = "dsh-session-workbench/WorkspacePicker.module.css";
		...
		var WorkspacePicker_module_css_default = {
			"modalAction": "F4jEqG_modalAction",
			"modalError": "F4jEqG_modalError",
			"menuStatus": "F4jEqG_menuStatus"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:module:src/client/WorkspaceBrowser.module.css.mjs
		const css = ".yg_AMa_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}.yg_AMa_root.yg_AMa_rail{padding-right:0}.yg_AMa_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.yg_AMa_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yg_AMa_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}.yg_AMa_root:not(.yg_AMa_rail) .yg_AMa_sectionHeader{margin-top:2px;margin-right:-4px}.yg_AMa_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}.yg_AMa_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}.yg_AMa_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}.yg_AMa_searchSlotExpanded{max-width:100%;padding-left:0}.yg_AMa_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}.yg_AMa_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}.yg_AMa_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}.yg_AMa_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline-start:-2px;margin-inline-end:-2px;padding:0 4px 0 0}.yg_AMa_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.yg_AMa_searchExpanded .yg_AMa_searchButton{width:28px;height:30px}.yg_AMa_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yg_AMa_searchExpanded .yg_AMa_searchButton:hover{background:0 0}.yg_AMa_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}.yg_AMa_searchExpanded .yg_AMa_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}.yg_AMa_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}.yg_AMa_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.yg_AMa_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yg_AMa_rail .yg_AMa_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}.yg_AMa_rail .yg_AMa_headerActions{max-width:none}.yg_AMa_rail .yg_AMa_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.yg_AMa_rail .yg_AMa_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}.yg_AMa_rail .yg_AMa_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}.yg_AMa_rail .yg_AMa_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.yg_AMa_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}.yg_AMa_rail .yg_AMa_listArea{margin-left:0;margin-right:0;padding-left:0}.yg_AMa_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}.yg_AMa_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}.yg_AMa_wide{animation:yg_AMa_wide-in .2s var(--ds-ease-in-out)}@keyframes yg_AMa_wide-in{0%{opacity:0}}.yg_AMa_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}.yg_AMa_flatList>*+*,.yg_AMa_searchTree>[role=treeitem]+[role=treeitem],.yg_AMa_groupSection>*+*{margin-top:2px}.yg_AMa_searchStatus,.yg_AMa_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.yg_AMa_searchWarning{color:var(--dsw-alias-label-secondary)}.yg_AMa_groupSection{position:relative}.yg_AMa_sessionGroupDrop{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px;background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, transparent);border-radius:6px}.yg_AMa_groupSection+.yg_AMa_groupSection{margin-top:4px}.yg_AMa_listTopDropIndicator,.yg_AMa_workspaceDropBefore:before,.yg_AMa_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}.yg_AMa_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}.yg_AMa_listTopDropActive>.yg_AMa_workspaceDropBefore:first-child:before{display:none}.yg_AMa_workspaceDropBefore:before{top:-8px}.yg_AMa_workspaceDropAfter:after{bottom:-8px}.yg_AMa_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}.yg_AMa_groupSection>.yg_AMa_sessionOverflowButton{margin-top:0}.yg_AMa_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}.yg_AMa_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}.yg_AMa_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}.yg_AMa_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}.yg_AMa_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}.yg_AMa_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}.yg_AMa_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){.yg_AMa_wide{animation:none}.yg_AMa_search,.yg_AMa_sectionLabel,.yg_AMa_searchSlot,.yg_AMa_searchInput,.yg_AMa_headerActions{transition:none}}";
		const tagId = "dsh-session-workbench/WorkspaceBrowser.module.css";
		...
		var WorkspaceBrowser_module_css_default = {
			"sessionGroupDrop": "yg_AMa_sessionGroupDrop",
			"renameInput": "yg_AMa_renameInput",
			"clearButton": "yg_AMa_clearButton",
			"list": "yg_AMa_list",
			"deleteAction": "yg_AMa_deleteAction",
			"searchButton": "yg_AMa_searchButton",
			"headerActions": "yg_AMa_headerActions",
			"wide-in": "yg_AMa_wide-in",
			"groupSection": "yg_AMa_groupSection",
			"sectionHeader": "yg_AMa_sectionHeader",
			"listArea": "yg_AMa_listArea",
			"listTopDropIndicator": "yg_AMa_listTopDropIndicator",
			"workspaceDropBefore": "yg_AMa_workspaceDropBefore",
			"searchSlotExpanded": "yg_AMa_searchSlotExpanded",
			"listTopDropActive": "yg_AMa_listTopDropActive",
			"searchStatus": "yg_AMa_searchStatus",
			"sessionOverflowButton": "yg_AMa_sessionOverflowButton",
			"searchWarning": "yg_AMa_searchWarning",
			"searchInput": "yg_AMa_searchInput",
			"fade": "yg_AMa_fade",
			"workspaceDropAfter": "yg_AMa_workspaceDropAfter",
			"searchExpanded": "yg_AMa_searchExpanded",
			"deleteStatus": "yg_AMa_deleteStatus",
			"headerActionsHidden": "yg_AMa_headerActionsHidden",
			"iconButton": "yg_AMa_iconButton",
			"rail": "yg_AMa_rail",
			"search": "yg_AMa_search",
			"flatList": "yg_AMa_flatList",
			"sectionLabelHidden": "yg_AMa_sectionLabelHidden",
			"searchSlot": "yg_AMa_searchSlot",
			"treeBody": "yg_AMa_treeBody",
			"renameError": "yg_AMa_renameError",
			"sectionLabel": "yg_AMa_sectionLabel",
			"wide": "yg_AMa_wide",
			"root": "yg_AMa_root",
			"searchTree": "yg_AMa_searchTree",
			"empty": "yg_AMa_empty"
		};
		//#endregion
		...
		*/
		...
		/** Resolve the row or Workspace group under a pointer-driven Session drag. */
		function pointerSessionDropAt(clientX, clientY) {
			const hit = document.elementFromPoint(clientX, clientY);
			if (hit === null) return void 0;
			const row = hit.closest("[data-session-drop-id][data-session-drop-account]");
			if (row !== null) {
				const accountKey = row.dataset.sessionDropAccount;
				const id = row.dataset.sessionDropId;
				if (accountKey === void 0 || id === void 0) return void 0;
				const rect = row.getBoundingClientRect();
				return {
					accountKey,
					id,
					half: clientY < rect.top + rect.height / 2 ? "before" : "after"
				};
			}
			const accountKey = hit.closest("[data-session-drop-group]")?.dataset.sessionDropGroup;
			return accountKey === void 0 ? void 0 : {
				accountKey,
				half: "before"
			};
		}
		/** The scrolling session tree; unmounting drops the sessions subscription and expand-all state. */
		function SessionTree({ useSessions, startSession, open, forkSession, workspaces, archivedSessionIds, onRenameRequest, onDeleteRequest, onSessionRename, onSessionArchive, onSessionExport, onSessionDelete, insertWorkspaceBefore, insertSessionBefore, migrateSession, orderBy, groupExpansion, setGroupExpanded, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, home, t }) {
			...
			const commitSessionDrag = (activeDrag, over) => {
				...
				if (activeDrag.accountKey !== over.accountKey) {
					if (targetGroup.workspaceId === void 0) return;
					migrateSession(activeDrag.sessionId, targetGroup.workspaceId).then((childId) => {
						if (orderBy === "manual" && anchor !== void 0) return insertSessionBefore(targetGroup.workspaceId, childId, anchor);
					}).catch((reason) => {
						console.warn("session migration rejected:", reason);
					});
					return;
				}
				if (anchor === activeDrag.sessionId) return;
				const sourceIndex = targetGroup.sessions.findIndex((session) => session.id === activeDrag.sessionId);
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [groups.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								"data-session-drop-group": group.key,
								className: clsx(WorkspaceBrowser_module_css_default.groupSection, workspaceMarker === "before" && WorkspaceBrowser_module_css_default.workspaceDropBefore, workspaceMarker === "after" && WorkspaceBrowser_module_css_default.workspaceDropAfter, drag?.over?.accountKey === group.key && drag.over.id === void 0 && WorkspaceBrowser_module_css_default.sessionGroupDrop),
								onDragOver: (e) => {
									...
									if (activeDrag === null || workspaceId === void 0 || activeDrag.accountKey === group.key) return;
									e.preventDefault();
									e.dataTransfer.dropEffect = "move";
									const next = {
										...activeDrag,
								...
								children: [
									...
									(expandedSessionGroups.includes(group.key) ? group.sessions : group.sessions.slice(0, COLLAPSED_SESSION_LIMIT)).map((node) => {
										const compatibleDrag = drag !== null && (drag.accountKey === group.key || group.workspaceId !== void 0);
										const marker = compatibleDrag && drag.over?.accountKey === group.key && drag.over.id === node.id ? drag.over.half : null;
										const dragProps = {
											accountKey: group.key,
											start: () => {
											...
											pointer: {
												move: (clientX, clientY) => {
													const activeDrag = dragRef.current;
													if (activeDrag === null) return;
													const over = pointerSessionDropAt(clientX, clientY);
													const targetGroup = over === void 0 ? void 0 : groups.find((candidate) => candidate.key === over.accountKey);
													const compatible = over !== void 0 && targetGroup !== void 0 && (activeDrag.accountKey === over.accountKey || targetGroup.workspaceId !== void 0);
													const next = {
														...activeDrag,
														over: compatible ? over : null
													};
													dragRef.current = next;
													setDrag(next);
												},
												drop: (clientX, clientY) => {
													...
													const over = pointerSessionDropAt(clientX, clientY);
													const targetGroup = over === void 0 ? void 0 : groups.find((candidate) => candidate.key === over.accountKey);
													if (activeDrag !== null && over !== void 0 && targetGroup !== void 0 && (activeDrag.accountKey === over.accountKey || targetGroup.workspaceId !== void 0)) {
														commitSessionDrag(activeDrag, over);
														return;
													}
													dragRef.current = null;
													setDrag(null);
		...
		function FlatList({ useSessions, open, forkSession, onSessionRename, onSessionArchive, onSessionExport, onSessionDelete, archivedSessionIds, orderBy, sessionOrderByAccount, sessionUpdatedAtByAccount, syncSessionOrderAccount, setSessionOrder, t }) {
			const list = useSessions((s) => s);
		...
		*/
		function WorkspaceBrowser({ wide, expandSidebar, useSessions, useWorkspaces, useStore, actions, startSession, open, renameSession, forkSession, renameWorkspace, deleteWorkspace, insertWorkspaceBefore, archiveSession, exportSession, deleteSession, migrateSession, insertSessionBefore, createWorkspace, searchSessions, searchResultLimit, useDirectoryFlow, useHostDescription, renderSlot, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
						...
						children: [sessionDeleting && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: WorkspaceBrowser_module_css_default.deleteStatus,
							role: "status",
							children: t("delete.session.pending")
						}), sessionDeleteError !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: WorkspaceBrowser_module_css_default.renameError,
							role: "alert",
		...
		*/
		...
		const zh = {
			...
			"menu.fork": "分叉会话",
			"menu.exportSession": "导出会话",
			"menu.archiveSession": "归档会话",
			"menu.deleteSession": "删除会话",
			"delete.session.title": "永久删除会话",
			"delete.session.desc": "将永久删除“{name}”的会话记录。此操作无法撤销。",
		...
		const en = {
			...
			"menu.exportSession": "Export session",
			"menu.archiveSession": "Archive session",
			"menu.deleteSession": "Delete session",
			"delete.session.title": "Permanently delete session",
			"delete.session.desc": "This permanently deletes the session log for “{name}”. This action cannot be undone.",
		...
		const NS = "workspace";
		/** Resolve one required capability without hiding an incompatible Host. */
		function requireSessionCapability(sessions, capability) {
			const value = sessions[capability];
			if (typeof value !== "function") throw new Error(`dsh-session-workbench requires the Harness session.${capability} capability`);
			return value.bind(sessions);
		}
		/**
		...
		function apply(ctx) {
			...
			const browserInjected = () => ({
				...
				exportSession: (sessionId) => {
					...
					anchor.href = `/api/session.export?sessionId=${encodeURIComponent(sessionId)}&includeDescendants=true`;
					anchor.hidden = true;
				...
				deleteSession: async (sessionId) => {
					await requireSessionCapability(ctx.sessions, "delete")(sessionId);
				},
				migrateSession: (sessionId, workspaceId) => requireSessionCapability(ctx.sessions, "migrate")(sessionId, workspaceId),
