...
export declare const zh: {
    ...
    'menu.fork': string;
    'menu.exportSession': string;
    'menu.archiveSession': string;
    'menu.deleteSession': string;
    'delete.session.title': string;
    'delete.session.desc': string;
    'delete.session.pending': string;
