 ...
 * 2. Client half — src/client/index.ts → lib/client.js (CJS closure-factory
 ...
 *
 * The client shape follows the independent community bundle pattern used by
 * dsh-web and dsh-talk-map. CSS handling:
